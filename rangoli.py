...
colors  = ["red","green","blue","pink","yellow","dark red","lime","dark blue","medium violet red", "cyan","saddle brown","dark gray","dark orange","magenta"]
#dark_colors
dark_colors = ["white","red","green","blue","pink","yellow"]
